...
export type TeacherSidebarNavProps = {
  /** Mobil menü kapama (Offcanvas) */
  onNavigate?: () => void;
};

/** Menü öğeleri — masaüstü sidebar ve mobil Offcanvas içinde ortak */
export function TeacherSidebarNav({ onNavigate }: TeacherSidebarNavProps) {
