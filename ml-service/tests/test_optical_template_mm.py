...
def test_turkish_column_crop_defaults() -> None:
    ...
    assert tm.page_w_mm == pytest.approx(25.5)
    assert tm.page_h_mm == pytest.approx(85.0)
    assert tm.q1_a_cx_mm == pytest.approx(5.5)
    assert tm.q1_a_cy_mm == pytest.approx(10.5)
    assert tm.ad_centers_span_mm == pytest.approx(13.0)
    assert tm.q1_q20_centers_span_mm == pytest.approx(74.0)
